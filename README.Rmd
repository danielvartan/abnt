...
If you know your way thought LaTeX, you can change the order of languages in the `\RequirePackage[spanish, brazil, english]{babel}` command present in `_extensions/tesesusp/tesesusp.cls`. This way, the last one will become the main language of the document.
