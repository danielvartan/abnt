...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, colback={codebgcolor}, boxrule=0pt, frame hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, enhanced]}{\end{tcolorbox}}\fi
\makeatother
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/unnamed-chunk-15-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{qmd/development_files/figure-pdf/unnamed-chunk-16-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{qmd/development_files/figure-pdf/unnamed-chunk-18-1.png}}
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toprule=.15mm, breakable, bottomtitle=1mm, toptitle=1mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, bottomrule=.15mm]
