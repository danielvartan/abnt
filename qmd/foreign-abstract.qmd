...
[Sobrenome do autor], [Nome(s) do autor]. __{abnt}: formato Quarto para teses e dissertações ABNT__. {{< var year >}}. {{< var type-of-work >}} ({{< var academic-degree >}}) -- {{< var school >}}, {{< var university >}}, {{< var location >}}, {{< var year >}}.
